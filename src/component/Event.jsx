...
import { Cake, Heart, Award, Users, Play } from "lucide-react";
...
export const Event = () => {
  ...
  const eventVideos = [
    {
      id: 1,
      title: "Birthday Party - Unforgettable Celebration",
      artist: "Birthday Package",
    ...
    {
      id: 4,
      title: "Corporate Event - Business Gathering",
      artist: "Corporate Package",
      thumbnail: "/logotab1.jpg",
      url: "https://drive.google.com/file/d/1NCCX5FDE_G7LgsDh2K4jBcwxs6R76BkQ/preview",
    ...
    {
      id: 5,
      title: "Small Gathering - Intimate Moments",
      artist: "Small Party Package",
      thumbnail: "/logotab1.jpg",
      url: "https://drive.google.com/file/d/1NCCX5FDE_G7LgsDh2K4jBcwxs6R76BkQ/preview",
