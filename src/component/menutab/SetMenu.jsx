    ...
    <div className="mb-10 font-sans">
      ...
      <div className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto px-4">
        {setMenus.map((setMenu) => (
          <div
            key={setMenu.id}
            className={`relative bg-gradient-to-br ${setMenu.color} rounded-3xl overflow-hidden text-white shadow-2xl hover:shadow-3xl transition-all duration-500 group`}
          >
            {/* Decorative Elements */}
